...
class Test123:
    with open(test_bug27204_dir, encoding="utf-8") as f:
        ...
        test_student_toast_datas = datas["test_check_upload_exists_plan"]
    ...
    def _check_upload_exists_plan(self, data):
        '''
        验证上传已排计划
        '''
    ...
    def _check_add_plan_succeed(self, data):
        '''
        验证添加計劃成功
        '''
    ...
    @pytest.mark.parametrize("data", test_student_toast_datas)
    def test_student_toast(self,data):
        self._check_upload_exists_plan(self,data)